...
//     Compute the remainder when the adjusted total is divided by 10. Subtract
...
int main(void) {
  ...
  int odd_sum = i1 + i3 + i5 + i7 + i9 + i11;
  int even_sum = i2 + i4 + i6 + i8 + i10 + i11;
  int check_digit = 9 - ((((even_sum * 3) + odd_sum) - 1) % 10);
